...
"font-size: 12px;")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.labelTitle.setText(QCoreApplication.translate("SplashScreen", u"<html><head/><body><p>SYSTEM MONITOR</p></body></html>", None))
        ...
        self.labelCredits.setText(QCoreApplication.translate("SplashScreen", u"<span>&#169;</span> Earth Inversion", None))
    # retranslateUi
